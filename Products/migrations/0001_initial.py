# Generated by Django 5.2.3 on 2025-10-17 09:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('image_url', models.URLField(blank=True, default='https://f005.backblazeb2.com/file/Ecommerce-App-media/product_images/default.jpg', max_length=1024, null=True)),
                ('manufactured_date', models.CharField(blank=True, max_length=10, null=True, validators=[Products.models.validate_manufacture_date])),
